...
public final class EssDocsWindows {
    ...
    public static void registerBuiltins() {
        List<String> overviewLines = List.of(
            ...
            "PantheonAPI — Pantheon Hub, then Hermes / Aegis from the dock.",
            "Utility — ops tools (CTL, WhatLIB?, …) with search / filter.",
            "Other Mods — menus other authors register (search / filter).",
        ...
        register("esl", "ESL", "Backend foundation", "esl", "ESL", 10, List.of(
            ...
            "",
            "EslConfig",
            "  begin(rootComment) — start a ForgeConfigSpec.Builder",
        ...
        register("esh", "ESH", "F9 hub layer", "esh", "ESH", 30, List.of(
            ...
            "",
            "What it does",
            "Owns F9 only. Hosts sectioned windows: ESS (studio wiki + ESC tools), PantheonAPI (Pantheon Hub → dock → Hermes / Aegis), Utility (ops / power-user tools — search / filter), Other Mods (third-party registrations — search / filter).",
            ...
            "Other Mods — find another mod’s menu (search / filter on that tab).",
            "PantheonAPI — open Pantheon Hub, then pick Hermes / Aegis from the dock.",
            ...
            "Gameplay / settings menus → EshSection.MODS (Other Mods).",
            "Ops / power-user tools → EshSection.UTILITY (same search / Author·Title·Group filter as Other Mods).",
            "Studio docs / Pantheon family → ESS / PANTHEON as appropriate.",
            "Pantheon family: register Pantheon Hub only; children open from the Hub dock — do not register Hermes / Aegis as separate ESH leaves.",
            ...
            "  .section(EshSection.MODS | ESS | PANTHEON | UTILITY)",
            "  .author(\"Your Name\") — Other Mods / Utility grouping / search",
            ...
            "  .build()",
            "",
            "EshSection — ESS, PANTHEON, UTILITY, MODS (Other Mods)",
            "",
            "Example (Other Mods)",
        ...
        register("integrators", "For Mod Authors", "Plug into the stack", "ess", "ESS", 1, List.of(
            ...
            "",
            "Section etiquette",
            "Other Mods (EshSection.MODS) — third-party author menus (search / Author·Title·Group filter).",
            "Utility (EshSection.UTILITY) — ops / power-user tools; same search / filter chrome as Other Mods.",
            "ESS / PantheonAPI — Extra Special Studio curated surfaces; do not park random gameplay GUIs there.",
            "Pantheon children open from Pantheon Hub’s dock — register the hub entry, not every leaf.",
            "",
            "JSON alternative",
    ...
    private static final class DocScreen extends EshEscPageScreen {
        ...
        public boolean mouseScrolled(double mouseX, double mouseY, double delta) {
            if (panelBounds.contains(mouseX, mouseY)) {
                scrollPx = Math.max(0, scrollPx - (int) Math.signum(delta) * (font.lineHeight + 2) * 2);
                return true;
            }
